...
| Uncompressed upload | `1082.47 KiB` |
| Gzip upload | `261.72 KiB` |
...
5. creates, lists, gets, updates, and deletes through generated D1 calls;
6. verifies full-page and htmx fragment representations;
7. reads persistent audit rows and proves that bound/form values are absent.
